...
class script(object):
    HOME_BUTTONURL_UPDATES = environ.get("HOME_BUTTONURL_UPDATES", 'https://telegram.me/R_Mvzz')
    START_TXT = environ.get("START_TXT", '''<b>Hello {} 👋🏻 Im R_Mvzz Official Movie Search Bot \n start me in your dm to know more 😁.</b>

<i>Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛᴏ sᴇᴇ ᴛʜᴇ ᴍᴀɢɪᴄ ᴏʀ ʀᴇᴀᴅ ᴍᴏʀᴇ ғʀᴏᴍ ᴛʜᴇ ᴍᴇɴᴜ ʙᴇʟᴏᴡ</i>''')
    HELP_TXT = """𝙷𝙴𝚈 {}
𝙷𝙴𝚁𝙴 𝙸𝚂 𝙼𝚈 𝙷𝙴𝙻𝙿 𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝚂."""
    ABOUT_TXT = """👨‍💻 Developer :- <a href=https://t.me/STREAMZ><b>STREAMZ Movie Group </b></a>\n
📝 Language:- Python3 \n
📢 Updates Channel:- <a href=https://telegram.me/STREAMZ><b></b>STREAMZ</a>\n"""
