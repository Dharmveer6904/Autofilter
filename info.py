...
BOT_TOKEN = environ.get('BOT_TOKEN', "5065015315:AAEe7vczltUfz2Hh-Ioq_Q6N_KPFgXW7Hds")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://nataliermvzzbot:nataliermvzzbot@cluster0.ks7cnze.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001547941154'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Off_Topic_discussion')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), True)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "ɴᴀᴍᴇ: <code>{file_name}</code> \n\nᴊᴏɪɴ ɴᴏᴡ: [Join backup](https://t.me/REQUEST_MOvizz)</b>")
...
DOWNLOAD_TEXT_URL = "https://t.me/movies_web0"
